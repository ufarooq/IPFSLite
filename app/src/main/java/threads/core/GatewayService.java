...
public class GatewayService {
    ...
    public static List<threads.core.api.Peer> getConnectedPeers(
    ...
    public static List<threads.core.api.Peer> connectStoredAutonat(
    ...
    public static List<threads.core.api.Peer> connectStoredPubsub(
            @NonNull Context context, int numConnections, int timeout) {
    ...
    public static List<threads.core.api.Peer> connectStoredRelays(
    ...
    public static List<threads.core.api.Peer> connectStoredPeers(
