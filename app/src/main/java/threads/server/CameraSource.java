...
public class CameraSource {
    ...
    // select shutdown, but not exactly the same values for these.
     ...
     * <p>
     * This camera source may be restarted again by calling  or
     ...
     * activated previously with  or {@link #start(SurfaceHolder)}.  The camera
     ...
     * (between  or {@link #start(SurfaceHolder)} and before {@link #stop()} or {@link #release()}).
     * <p>
    ...
    /**
     * Callback interface used to notify on auto focus start and shutdown.
     * <p>
