...
public class RTCPeerConnection {
    ...
    private List<PeerConnection.IceServer> signalingParameters;
    ...
    public void createPeerConnection(final VideoSink localRender, final VideoSink remoteSink,
                                     final VideoCapturer videoCapturer, final List<PeerConnection.IceServer> signalingParameters) {
    ...
    private void createPeerConnectionInternal() {
        ...
        PeerConnection.RTCConfiguration rtcConfig =
                new PeerConnection.RTCConfiguration(signalingParameters);
